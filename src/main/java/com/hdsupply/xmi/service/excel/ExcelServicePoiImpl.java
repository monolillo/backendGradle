...
public class ExcelServicePoiImpl implements ExcelService {
    ...
    private static final String[] COLUMNS = {"ItemNumber", "Name", "Price", "In Stock", "Minimun", "Max", "Critical"};
	...
	public byte[] convertToExcel(List<ProductCatalog> products) throws IOException {
        ...
        for(ProductCatalog product: products) {
            ...
            row.createCell(5)
            	.setCellValue(product.getMax());
            
            row.createCell(6)
            	.setCellValue(product.getCritical() == true ? "Yes" : "No");
